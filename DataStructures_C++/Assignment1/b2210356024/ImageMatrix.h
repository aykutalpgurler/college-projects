...
public:
    ...
    ImageMatrix& setHeight(int height) {this->height = height; return *this;}
    ImageMatrix& setWidth(int width) {this->width = width; return *this;}
    
    void set_data(int i, int j, double value);
    
    void write_to_file(const std::string &filename); // Write to text file
