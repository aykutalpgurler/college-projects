...
private:
    std::string getClientIP(const std::vector<Client>& clients, const std::string& clientId);
    std::string getClientMac(const std::vector<Client>& clients, const std::string& clientId);
//    Client getClient(const vector<Client>& clients, const string& clientId);
